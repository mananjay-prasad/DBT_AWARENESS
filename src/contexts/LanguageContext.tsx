...
const translations: Record<'en' | 'hi', Record<string, TranslationValue>> = {
  en: {
    ...
    'documents.filter': 'All Categories',
    'documents.showing': 'Showing',
    'documents.total': 'Total Downloads:',
    'documents.essential': 'Essential Documents',
    'documents.all': 'All Documents',
    'documents.noResults': 'No documents found',
    'documents.noResults.desc': 'Try adjusting your search terms or category filters.',
    ...
    'help.faq.a2': 'Visit your bank branch with Aadhaar card and bank passbook. Fill the DBT enrollment form and submit. Bank will activate DBT within 2-3 working days.',
    'help.faq.q3': 'Why is my scholarship not being disbursed?',
    'help.faq.a3': 'Common reasons include: DBT not enabled, account inactive, name mismatch between Aadhaar and bank account, or incomplete application documents.',
  ...
  hi: {
    ...
    'schools.type.all.label': 'सभी प्रकार',
    'schools.type.government.label': 'सरकारी',
    'schools.type.private.label': 'निजी',
    'schools.type.central.label': 'केंद्रीय सरकार',
